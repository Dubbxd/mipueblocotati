...
export const menuItems: MenuItem[] = [
  ...
  I('super-nachos',              'appetizers', 'Súper nachos',                  'Super Nachos',              16.25, undefined, undefined, ['popular','vegetarian'], '/assets/gallery/super-nachos.jpg'),
  I('super-nachos-meat',         'appetizers', 'Súper nachos con carne',        'Super Nachos with Meat',    18.75, undefined, undefined, ['popular'], '/assets/gallery/super-nachos.jpg'),
  ...
  I('tostada-meat',     'a-la-carte', 'Tostada (cualquier carne)',  'Tostada (Any Meat)',          10.75, undefined, undefined, [], '/assets/gallery/untitled-03.jpg'),
  I('tostada-mexicana', 'a-la-carte', 'Tostada mexicana',           'Tostada Mexicana',            11.75, undefined, undefined, [], '/assets/gallery/untitled-03.jpg'),
  I('chile-relleno',    'a-la-carte', 'Chile relleno',              'Chile Relleno',               10.25, undefined, undefined, ['vegetarian'], '/assets/gallery/chile-relleno.jpg'),
  ...
  I('taco-salad',           'specialties', 'Ensalada de taco',            'Taco Salad',               18.75, 'Arroz, frijoles, lechuga, jitomate, queso, crema, guacamole', 'Rice, beans, lettuce, tomato, cheese, sour cream, guacamole', ['popular'], '/assets/gallery/taco-salad-served.jpg'),
  ...
  I('tostada-raspada',      'specialties', 'Tostada raspada grande',      'Big Tostada Raspada',      25.99, 'Tostada grande con carne, frijoles, lechuga, queso, jitomate y aguacate', 'Big tostada with meat, beans, lettuce, cheese, tomato and avocado', ['popular'], '/assets/gallery/tostada-raspada.jpg'),
  ...
  I('birria-soup',    'soups', 'Birria',         'Birria',        27.00, 'Con arroz y frijoles. Sólo sábado y domingo', 'With rice and beans. Saturday and Sunday only', [], '/assets/gallery/birria-bowl.jpg'),
  I('siete-mares-soup','soups','Sopa siete mares','Siete Mares Soup', 33.50, 'Pulpo, camarón, almejas, callo, pescado, cangrejo, papa y zanahoria', 'Octopus, shrimp, clams, scallops, fish, crab, potato and carrot', ['seafood'], '/assets/gallery/siete-mares-soup.jpg'),

  // ============ TACOS ============
  I('taco-meat',      'tacos', 'Taco (cualquier carne)', 'Taco (any meat)',  5.75, undefined, undefined, [], '/assets/gallery/untitled-10.jpg'),
  ...
  I('burrito-super',     'burritos', 'Burrito súper',         'Super Burrito',         16.25, '+ queso, crema y guacamole', '+ cheese, sour cream and guacamole', ['popular'], '/assets/gallery/burrito-served.jpg'),
  ...
  I('chimichanga',       'burritos', 'Chimichanga',           'Chimichanga',           17.50, undefined, undefined, [], '/assets/gallery/untitled-08.jpg'),
  ...
  I('molcajete',            'meats', 'Molcajete',             'Molcajete',            36.00, 'Arrachera, camarón, pollo, queso fresco, cebolla, chorizo, jitomate, champiñones, nopal en molcajete', 'Skirt steak, shrimp, chicken, queso fresco, onion, chorizo, tomato, mushrooms, cactus in stone bowl', ['popular','seafood'], '/assets/gallery/molcajete-bowl.jpg'),
  I('fajitas-mix',          'meats', 'Fajitas mixtas',        'Fajitas Mix',          31.50, 'Arrachera, pollo, camarón, cebolla cambray, jitomate, pimientos, champiñones, guacamole, crema', 'Skirt steak, chicken, shrimp, scallions, tomato, peppers, mushrooms, guacamole, sour cream', ['popular','seafood'], '/assets/gallery/untitled-05.jpg'),
  ...
  I('carne-asada-mp',       'meats', 'Carne asada Mi Pueblo', 'Carne Asada Mi Pueblo',28.00, 'Arrachera con pimientos asados, cebollas y jalapeños', 'Skirt steak with grilled peppers, onions and jalapeños', ['popular'], '/assets/gallery/untitled-11.jpg'),
  ...
  I('alambre',              'meats', 'Alambre',               'Alambre',              28.75, 'Arrachera y chorizo con cebolla, jitomate, pimiento, champiñones y queso', 'Skirt steak and chorizo with onion, tomato, peppers, mushrooms and cheese', undefined, '/assets/gallery/alambre-meal.jpg'),
  ...
  I('pollo-con-crema',      'meats', 'Pollo con crema',       'Pollo con Crema',      25.75, 'Pechuga de pollo en crema', 'Chicken breast in cream sauce', undefined, '/assets/gallery/pollo-con-crema.jpg'),
  ...
  I('camarones-steak',    'seafood', 'Camarones con steak',  'Shrimp with Steak',     28.50, 'Arrachera y camarón con pimiento, cebolla y champiñones', 'Skirt steak and shrimp with peppers, onion and mushrooms', ['seafood','popular'], '/assets/gallery/camarones-con-steak.jpg'),
  ...
  I('filete-pescado',     'seafood', 'Filete de pescado',    'Fish Fillet',           27.75, 'Filete asado con arroz y frijoles', 'Grilled fillet with rice and beans', ['seafood'], '/assets/gallery/untitled-13.jpg'),
  ...
  I('mojarra-frita',      'seafood', 'Mojarra frita',        'Fried Mojarra',         27.50, 'Mojarra entera frita, arroz y frijoles', 'Whole fried tilapia, rice and beans', ['seafood'], '/assets/gallery/untitled-13.jpg'),
  ...
  I('chilaquiles',      'breakfast', 'Chilaquiles',            'Chilaquiles',          16.75, 'Verdes o rojos', 'Green or red', [], '/assets/gallery/untitled-12.jpg'),
